...
// */
//
//public class SAPExistsFunction extends AbstractJqlFunction {
//
...
//
//    public SAPExistsFunction(final SearchHandlerManager searchHandlerManager,
...
//        logger.debug( "getValues :: fields {} ", queryCreationContext.getDeterminedProjects());
//        if (fields.size() != 1) {
//            return Collections.emptyList();
//        }
//
//        CustomField customField = fields.iterator().next();
//        RestValuesViewHelper viewHelper = RestValuesViewHelper.getViewHelper(customField);
//        logger.debug( "getValues :: viewHelper is  {} ", viewHelper);
//
//        List<QueryLiteral> queryLiteralList = new ArrayList<QueryLiteral>();
//
//        String queryValue = arguments.get(0);
//        Set<Object> queryValues = viewHelper.getQueryValues(queryValue);
...
//     * @return the set of {@link CustomField}s which map to the clause name and are also
